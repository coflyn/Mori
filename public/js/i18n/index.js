export const translations = {
  en: {
    ...
    "batch-input-placeholder": "Paste multiple links (one per line)...",
    "btn-analyze": "Analyze",
    ...
    "pin-set-title": "Set New 4-Digit PIN",
    "pin-confirm-title": "Confirm 4-Digit PIN",
    "toast-pin-incorrect": "Incorrect PIN!",
    "toast-pin-mismatch": "PINs do not match!",
    "toast-pin-saved": "PIN saved successfully",
  ...
  id: {
    ...
    "batch-input-placeholder": "Tempel banyak tautan (satu per baris)...",
    ...
    "pin-set-title": "Buat 4-Digit PIN Baru",
    "pin-confirm-title": "Konfirmasi 4-Digit PIN",
    "toast-pin-incorrect": "PIN Salah!",
    "toast-pin-mismatch": "PIN Tidak Cocok!",
    "toast-pin-saved": "PIN berhasil disimpan",
  ...
  ja: {
    ...
    "batch-input-placeholder": "複数のリンクを貼り付け（1行に1つ）...",
    "btn-analyze": "解析する",
    ...
    "pin-set-title": "新しい4桁のPINを設定",
    "pin-confirm-title": "4桁のPINを確認",
    "toast-pin-incorrect": "PINが正しくありません",
    "toast-pin-mismatch": "PINが一致しません",
    "toast-pin-saved": "PINが保存されました",
