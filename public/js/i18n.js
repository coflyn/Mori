export const translations = {
  en: {
    ...
    "toast-reduce-animation-on": "Reduce Animation enabled",
    "toast-reduce-animation-off": "Reduce Animation disabled",
    ...
    "menu-general-desc": "Language, Auto-Paste, Privacy Lock",
    "menu-storage-title": "Storage & Download",
    "menu-storage-desc": "Path, Quality, Download Behavior",
    "menu-appearance-title": "Look & feel",
    "menu-appearance-desc": "Theme, Color accent, Data saver",
    "menu-advanced-title": "Advanced",
    "menu-advanced-desc": "Auto-clear history, Backup & Reset",
  ...
  id: {
    ...
    "label-reduce-animation": "Kurangi Animasi",
    ...
    "toast-reduce-animation-on": "Kurangi Animasi aktif",
    "toast-reduce-animation-off": "Kurangi Animasi dimatikan",
    "share-msg":
    ...
    "menu-general-desc": "Bahasa, Tempel-Otomatis, Kunci Privasi",
    "menu-storage-title": "Penyimpanan & Unduhan",
    "menu-storage-desc": "Lokasi, Kualitas, Perilaku Unduhan",
    "menu-appearance-title": "Tampilan & rasa",
    "menu-appearance-desc": "Tema, Aksen Warna, Hemat data",
    "menu-advanced-title": "Lanjutan",
    "menu-advanced-desc": "Hapus Riwayat, Cadangan & Reset",
  ...
  ja: {
    ...
    "toast-datasaver-on": "「アニメーションを減らす」が有効になっています",
    "toast-datasaver-off": "データ節約無効",
    "toast-reduce-animation-on": "データ節約有効（サムネイルなし）",
    "toast-reduce-animation-off": "「アニメーションを減らす」が無効になっています",
    "share-msg":
    ...
    "menu-general-desc": "言語、自動貼り付け、プライバシーロック",
    "menu-storage-title": "ストレージとダウンロード",
    "menu-storage-desc": "保存先、画質、ダウンロード動作",
    "menu-appearance-title": "外観と操作感",
    "menu-appearance-desc": "テーマ、アクセントカラー、データ節約",
    "menu-advanced-title": "高度な設定",
    "menu-advanced-desc": "履歴の自動消去、バックアップとリセット",
